...
//    @Override
    @ExceptionHandler(VeiculoExcepetion.class)
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ErroResposta erroResposta = new ErroResposta(status.value(), "Enum inválido", LocalDateTime.now(), List.of(ex.getMostSpecificCause().getMessage()));
